...
inputs=[('CORTEX IGNITION',p/'build/cortex-current/baked/cortex_ignition_tech_demo_0_5.cue')]
if 'HALF-LIFE' in entries: inputs += [('HALF-LIFE',p/'games/hl-psx/dist/hl-psx.cue')]
inputs += [('VOXIDE',p/'games/voxide/dist/voxide.cue'),('NITROXIDE',p/'build/nitroxide/NitroXide/NitroXide.cue'),('GH-PSX',p/'games/gh-psx/dist/gh-psx.cue'),('PSOXIDE ARCADE',p/'games/psoxide-arcade/dist/psoxide-arcade.cue'),('HARDWARE TESTS',p/'games/PSoXide-runtime/build/examples/mipsel-sony-psx/release/hardware-tests.cue'),('QUAKE SHAREWARE',p.parent/'quake-psx-pinned/dist/quake-psx.cue')]
base=4
